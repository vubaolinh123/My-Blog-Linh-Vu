...
import styles from "./LatestNewItem.module.css";

type Props = {
  dataItem: any
};

const LatestNewsItem = ({dataItem}: Props) => {
  return (
    <div className={styles["latest-news-item"]}>
      ...
      <div className={styles["latest-news-item-content"]}>
        ...
        <span className={styles["latest-news-item__sub"]}>tác giả {dataItem.author}</span>
